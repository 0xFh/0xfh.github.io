...
- Is the well-defined course of action whenever a computer or network security incident occurs.
- It is the action or plan of dealing with intrusions, cyber theft, DOS, and other computer security-related events.
...
The incident handling process consists of four (4) phases (known as “the incident response life cycle”) :
...
(getting the team ready to handle incident)
...
- **Establish levels of detection by logically categorizing your network ;**
    ...
    3. **Host-level**
        ...
        - An example of host-level detection is a user being warned about a malicious executable by the host’s endpoint protection solution (such as Antivirus warning about a malicious program)
    4. **Application-level**

...
[](/assets/img/uploads/malware_traffic__analysis/mta5/_7.png)
...
As you can see, There is only 1 file written called `tghtop.exe` and this is the correct answer.
...
As you can see, The code seems to be obfuscated.. We can use any js beautifier just as [**de4js**](https://lelinhtinh.github.io/de4js/) to de-obfuscate it and then we can analyze it easly:

[](/assets/img/uploads/malware_traffic__analysis/mta5/22.png)

[](/assets/img/uploads/malware_traffic__analysis/mta5/_22.png)
...
[](/assets/img/uploads/malware_traffic__analysis/mta5/_23.png)
...
You can make sure of that by analyze the file using Disassembler/Debugger, or by using Online Scanner/Sandbox and you will get the same key.

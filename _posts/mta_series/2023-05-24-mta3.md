...
To view the details of the `http` alert, double-click on it.. You will notice that it is an HTTP request from `192.168.137.62` with a **user_agent** that specifies Windows as the operating system being used:
